...
namespace Oceanpayment\Wechat\Controller\Payment; 
...
class Notice extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Oceanpayment\Wechat\Model\PaymentMethod $paymentMethod,
    ...
    public function execute()
    {
        ...
        if($this->xml_parser($xml_str)){
            ...
            $return_info['pay_barCode']      = (string)$xml->pay_barCode;
            ...
            switch($this->validated($order)){
                ...
                case -1:
                    ...
                    $order->addStatusToHistory($model->getConfigData('pre_auth_order_status'), __(self::PUSH.'Payment Pending!'.$history));
                    $order->save();
                    break;
                case 2:
                    //在网站中已经是支付成功
