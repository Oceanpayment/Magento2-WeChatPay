 ...
 */
namespace Oceanpayment\Wechat\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Wechat\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Wechat\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentwechat/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentwechat/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentwechat/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
